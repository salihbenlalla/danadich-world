...
const MESSAGES = [
  "منذ 15 سبتمبر 2025، والقَدَر يكتب لنا حكاية لم يعرفها قلبي من قبل.",
  "كنتِ حلمًا يملأ شاشتي يا دندوشتي، واليوم أنتِ النبض الذي يملأ حياتي.",
  "أيامٌ قليلة، وسينتهي هذا البعد.. لنقف معًا تحت سماءٍ واحدة.",
  "صنعتُ لكِ هذا الفضاء لتلمسي روحي، حتى تشعري بي معكِ في كل لحظة.",
  "كل رجفة تشعرين بها في يدكِ الآن، هي نبضة قلبٍ يهمس باسمكِ.",
];

const MESSAGE_INTERVAL = 5500;
const COMPLETION_DELAY = 5000;
